	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			...
			<div class="nav-links">
				...
				<div class="nav-previous xxsmall marginvertical-xsmall"><?php previous_comments_link( '<span class="light-gray">&#9656;</span> ' . esc_html__( 'Older comments', '_s' ) ); ?></div>
				<div class="nav-next xxsmall marginvertical-xsmall"><?php next_comments_link( '<span class="light-gray">&#9656;</span> ' . esc_html__( 'Newer comments', '_s' ) ); ?></div>
